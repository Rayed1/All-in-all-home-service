...
<body>
    ...
    <div  class="popup popup_multi">
        ...
        <div class="open-popup">
            ...
            <p>1. Well Trained Home Workers</p>
            <p>2. Trusted Workers</p>
            <p>3. 24/7 Service</p><br>
            <h2>Pricing Terms</h2><br>
            <p>1. Only the Charge of Workers</p>
            <p>2. Visiting Charge is BDT 100 if no service is  availed</p>
            <p>3. Includes any transportation cost (if applicable)</p>
            <p>4. Payment Method is Only after Service</p>
    ...
    <div class="container">
        ...
        <form id="form" class="form">
            ...
            <label for="radio">Why Do You Need Electricians?</label>
        ...
        <div class="radio-list">
            <div class="radio-item">
                ...
                <label for="radio1">Cleaning House</label>
            </div>
            <div class="radio-item">
                <input type="radio" name="radio" id="radio2">
                <label for="radio2">Cleanin Washrooms</label>
            </div>
            <div class="radio-item">
                <input type="radio" name="radio" id="radio3">
                <label for="radio3">Cleaning Kitchen</label>
            </div>
            <div class="radio-item">
                <input type="radio" name="radio" id="radio4">
                <label for="radio4">Baby Sitting</label>
            </div>
