...
<body>
    ...
    <div  class="popup popup_multi">
        ...
        <div class="open-popup">
            ...
            <p>1. Expert Electrician</p>
            <p>2. Safety Assurance</p>
            <p>3. 24/7 Service</p>
            <p>4. 7 Days of Service Warranty24/7 Service</p><br>
    ...
    <div class="container">
        ...
        <div class="radio-list">
            <div class="radio-item">
                ...
                <label for="radio1">Electrical Checkup</label>
            </div>
            <div class="radio-item">
                <input type="radio" name="radio" id="radio2">
                <label for="radio2">Ceiling Fan Services</label>
            </div>
            <div class="radio-item">
                <input type="radio" name="radio" id="radio3">
                <label for="radio3">Light Servicing or Installation</label>
            </div>
            <div class="radio-item">
                <input type="radio" name="radio" id="radio4">
                <label for="radio4">Main Circuit Breaker Services</label>
            </div>
            <div class="radio-item">
                <input type="radio" name="radio" id="radio5">
                <label for="radio5">Exhaust Fan Servicing</label>
            </div>
        </div>
    </section>
