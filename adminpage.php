...
<body>
	...
	<!--<div class="text-center  btn btn-primary m-4"><a href="users.php">All Users</a></div>-->
     <!-- #region -->
     <a href="users.php">
							<button class="text-center mx-auto m-1 btn-sm btn btn-primary">All Users</button>
						</a>
        <a href="homepage.php">
	...
	<?php if(!empty($row)):?>
		<div class="row col-lg-8 border rounded mx-auto mt-5 p-2 shadow-lg">
			...
			<div class="col-md-8">
				<div class="h2">Users Profile</div>
				<table class="table table-striped">
					...
					<tr><th><i class="bi bi-telephone"></i> Phone Number</th><td><?=esc($row['PhoneNumber'])?></td></tr>
				</table>
			</div>
		</div>
	<?php else:?>
