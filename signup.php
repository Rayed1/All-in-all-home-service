...
<body>
	...
	<form method="post" onsubmit="myaction.collect_data(event, 'signup')">
		<div class="col-md-8 col-lg-4 border rounded mx-auto mt-5 p-4 shadow">
			...
			<div  class="text-center h2 ">REGISTER HERE</div>
			...
			<div class="input-group mt-3">
			  ...
			  <input name="PhoneNumber" type="text" class="form-control p-3" placeholder="+880" >
			</div>
			<div><small class="js-error js-error-PhoneNumber text-danger"></small></div>
            ...
            <div class= "input-group mt-3">
			<div class="g-recaptcha" data-sitekey="6Lf0TmYjAAAAAMKHoAUUaZZc5pGygu6Fk89n4P_Z"></div>
			</div>
	...
	var myaction  = 
	{
		...
		handle_result: function (result)
		{
			...
			if(obj.success)
			{
				...
				alert( "Please Remember your Email and Password");
